...
function [scores_lsim, scores_hmm, scores_svm, Label] = sim_calassification(C,T,train_number, test_number)
...
hmm_gmm_para_1 = chmm_gmm_para_par{I_row,I_col};
...
hmm_gmm_para_2 = chmm_gmm_para_par{I_row,I_col};
...
for tr =1:test_number
    ...
    P_Y_Model_1  = forward_backward_lsim( pi_0_1 , coupling_tetha_1  , transitions_matrices_1 ,  hmm_gmm_para_1 , Y_test );
    P_Y_Model_2 = forward_backward_lsim( pi_0_2 , Coupling_Tetha_2 , transitions_matrices_2   , hmm_gmm_para_2 , Y_test );
