...
for f=2:length(feature_names)
    ...
    for s=1:length(stimuli_names)
        ...
        load(['lsim_',feature_names{f}(1:end-4),'_s_',num2str(s),'.mat'],'lsim_gmm_para_all','transitions_matrices_all','coupling_tetha_all','pi_0_all','AIC_all','log_likelihood_all','BIC_all')
        ...
        save(['test_results_hmm_',num2str(f),'.mat'],'auc_avg','auc_avg_all',"auc_avg_best","auc_avg_all_best",'estlabels',"truelabels")
    end
end
